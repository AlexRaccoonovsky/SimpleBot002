...
namespace SBot003.ServiceStorage
{
    public static class TxtMessageStorage
    {
        ...
        public static string messageConnected { get; private set; } = "GromoBot Connected!";
        public static string pressEnterNotice { get; private set; } = "Press<Enter> for return to MainMenu";
    }
}
